...
DROP TABLE "MEMBER";
DROP TABLE "USERS";
DROP TABLE "CHICKEN_LIST";
DROP TABLE "SUPLEMEN_LIST";
DROP TABLE "SUPLEMEN";
DROP TABLE "CHICKEN";
CREATE TABLE "BOARD" (
...
--------------아이디와 날짜
insert into users values ('test1', 11, 1, '타입');
insert into member (MEMBER_ID, MNAME,MBIRTHDAY, GENDER,HEIGHT,WEIGHT)  values ('test1','테스트용 이름','19950718','남자', 178 , 80);
insert into for_day values ('20230915','ghwnswkd123@naver.com' );
insert into for_day values ('20230916','ghwnswkd123@naver.com' );
insert into for_day values ('20230917','ghwnswkd123@naver.com' );
insert into for_day values ('20230918','ghwnswkd123@naver.com' );
insert into for_day values ('20230919','ghwnswkd123@naver.com' );
