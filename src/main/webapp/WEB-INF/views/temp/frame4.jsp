<link href="${pageContext.request.contextPath }/resources/temp1/css/frame2.css" rel="stylesheet">
<link href="${pageContext.request.contextPath }/resources/temp1/css/bootstrap.min.css" rel="stylesheet">
<link href="${pageContext.request.contextPath }/resources/temp1/css/style.css" rel="stylesheet">

<link href="${pageContext.request.contextPath }/resources/temp1/css/font-awesome.min.css" rel="stylesheet">
<link href="${pageContext.request.contextPath }/resources/temp1/css/fontello.css" rel="stylesheet">
...
<div class="Menu_container__nQ4DV">
<ul class="Menu_list__XupHS">
<li style="margin: 40px; font-weight: 100; "><a href="/advanced/diet">다이어트 도우미</a></li>
<li style="font-weight: 100;"><a href="/advanced/bodyprofile">바디프로필 도우미</a></li>
<li style="font-weight: 100;"><a href="/advanced/cheating">치팅데이 도우미</a></li>
<li style="font-weight: 100;"><a href="/advanced/maintenance">유지어트 도우미</a></li>
<li style="font-weight: 100;"><a href="/advanced/loading">밴딩/로딩</a></li>
<li style="font-weight: 100;"><a href="/advanced/cycling">탄수화물 사이클링</a></li>
</ul>
</div>
...
<div id="id2">
 ...
 <table border="1">
	...
	<div class="main1">
      <a href=""><img src="${pageContext.request.contextPath }/resources/temp1/images/exercise helper.jpg" alt="Fitness Website Template"></a>
      </div>
