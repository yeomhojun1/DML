...
<div class="row">
						<div class="col-xl-3 col-md-6">
							<div class="card bg-secondary text-white mb-4">
								<div class="card-body card-cursor" onClick="location.href='${pageContext.request.contextPath }/memberexset/list';">체중 관리</div>
								<div
						...
						<div class="col-xl-3 col-md-6">
							<div class="card bg-secondary text-white mb-4">
								<div class="card-body card-cursor" onClick="location.href='${pageContext.request.contextPath }/diet/list';">식단 관리</div>
								<div
						...
						<div class="col-xl-3 col-md-6">
							<div class="card bg-secondary text-white mb-4">
								<div class="card-body card-cursor" onClick="location.href='${pageContext.request.contextPath }/member/mypage';">캘린더</div>
								<div
