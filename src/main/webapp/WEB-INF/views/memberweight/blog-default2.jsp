            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="post-block mb30">
                        <div class="post-img">
                            <a href="blog-single.html" class="imghover"><img src="images/blog-1.jpg" class="img-responsive" alt="Fitness Website Template"></a>
                        </div>
                        <div class="post-header">
                            <div class="post-title">
                                <h3><a href="blog-single.html" class="text-white" >여기는 제일 첫번째 칸이다</a></h3>
                            </div>
                            <div class="post-meta"> <span class="meta-date"><i class="icon-primary icon-1x icon-calendar"></i>여기에는 날짜 써주면됨</span></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="post-block mb30">
                        <div class="post-img">
                            <a href="blog-single.html" class="imghover"><img src="images/blog-2.jpg" class="img-responsive" alt="Fitness Website Template"></a>
                        </div>
                        <div class="post-header">
                            <div class="post-title">
                                <h3><a href="blog-single.html" class="text-white" >여기는 두번째 칸</a></h3>
                            </div>
                            <div class="post-meta"> <span class="meta-date"><i class="icon-primary icon-1x icon-calendar"></i>두번째칸 날짜</span></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="post-block mb30">
                        <div class="post-img">
                            <a href="blog-single.html" class="imghover"><img src="images/blog-3.jpg" class="img-responsive" alt="Fitness Website Template"></a>
                        </div>
                        <div class="post-header">
                            <div class="post-title">
                                <h3><a href="blog-single.html" class="text-white" >ARE SIX PACK ABS SIGN OF GOOD HEALTH?</a></h3>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="post-block post-gallery mb30">
                        <div class="post-img">
                            <div id="post-gallery" class="owl-carousel">
                                <a href="blog-single.html" class="imghover"><img src="images/blog-1.jpg" class="img-responsive" alt="Fitness Website Template"></a>
                                <a href="blog-single.html" class="imghover"><img src="images/blog-2.jpg" class="img-responsive" alt="Fitness Website Template"></a>
                                <a href="blog-single.html" class="imghover"><img src="images/blog-3.jpg" class="img-responsive" alt="Fitness Website Template"></a>
                            </div>
                    ...
                    <div class="post-header">
                        <div class="post-title">
                            <h3><a href="blog-single.html" class="text-white" >Give the gift of fitness this holiday</a></h3>
                        </div>
                        <div class="post-meta"> <span class="meta-date"><i class="icon-primary icon-1x icon-calendar"></i>28 november, 2017</span></div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="post-block mb30">
                        <div class="post-img">
                            <a href="blog-single.html" class="imghover"><img src="images/blog-5.jpg" class="img-responsive" alt="Fitness Website Template"></a>
                        </div>
                        <div class="post-header">
                            <div class="post-title">
                                <h3><a href="blog-single.html" class="text-white" >HOW TO ESTABLISH A NEW FITNESS ROUTINE</a></h3>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="post-block mb30 quote-block">
                        <div class="post-img">
                            <a href="#" class="imghover"><img src="images/blog-6.jpg" class="img-responsive" alt="Fitness Website Template"></a>
                        </div>
                        <div class="post-header">
                            <blockquote>
