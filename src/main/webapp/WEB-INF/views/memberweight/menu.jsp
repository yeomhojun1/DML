...
<div class="row">
						<div class="col-xl-3 col-md-6">
							<div class="card bg-primary text-white mb-4">
								<div class="card-body" onClick="location.href='${pageContext.request.contextPath }/weight';">체중관리</div>
								<div
									class="card-footer d-flex align-items-center justify-content-between" onClick="location.href='${pageContext.request.contextPath }/index';">
