...
<title>Daily Muscle Life | 주변 헬스장 찾기</title>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=0e24c012eccac57d7c64e5ed57b4c869&libraries=services,clusterer,drawing"></script>
<link
			...
			<main>
				<div class="container-fluid px-4">
					<div class="Menu_container">
							<ul class="Menu_list">
								<li style="font-weight: bold;"><a>주변 헬스장 찾기</a></li>
							</ul>
						</div>
				...
				<script type="text/javascript">		//지도 띄우는 코드
	// 마커를 담을 배열입니다
	var markers = [];

	var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
	    mapOption = {
	        center: new kakao.maps.LatLng(37.500173,127.034846), // 지도의 중심좌표
	        level: 3 // 지도의 확대 레벨
	    };  
