			...
			<main>
				<div class="container-fluid px-4">
							...
							<div class="modal-dialog modal-l">
								...
								<div class="modal-content">
									<div class="modal-header">
										<h3 class="modal-title" id="add">${member.mname }의일정추가</h3>
					...
					<div class="modal fade" id="listPlan">
						...
						<div class="modal-dialog modal-xl">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="dmllist">Modal title</h5>
				...
				<div class="modal fade" id="updatePlan">
					...
					<div class="modal-dialog modal-xm">
						<div class="modal-content">
							<div class="modal-header">
								<h3 class="modal-title" id="fix">${member.mname }의일정수정</h3>
								<button type="button" class="btn-close" data-bs-dismiss="modal"
									aria-label="Close"></button>
							</div>
							<div class="modal-body">
	...
	$(".forcalendar").click(forcalendarhandler);
	  ...
	  function workCalendar(now){
		...
		for (var i = 0; i < now.length; i++) {
		  htmlVal += '<div class="col-xl-3 col-md-6">'
		  +'<div class="card bg-secondary text-white mb-4">'
		  +'<div class="card-body card-cursorcollapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseCalendar'
		  +i+'" aria-expanded="false">'
		  +'제목 : '+now[i].title+' <br> 날짜 : '+now[i].startDate+' ~ '+now[i].endDate+'</div>'
		  +'<div class="collapse" id="collapseCalendar'+i+'">'
		  +'<div class="card-footer align-items-center justify-content-between card-cursor">'
		  +'내용 : <br><div class="content-wrap" style="word-wrap: break-word;">'+now[i].content
		  +'</div></div></div></div></div>';
		}
		htmlVal += '</div>';
		$(".testContent").html(htmlVal);
