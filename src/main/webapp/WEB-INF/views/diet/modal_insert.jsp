								...
								<div class="Plan_modal_food_contents__bU3Ad">
									<div>
										<div
											...
											<input placeholder="식품 검색" class="ant-input ant-input-borderless css-1s3dcof " type="text" value="">
														<button type="button"
														class="ant-btn css-1s3dcof ant-btn-default ant-input-search-button">검색</button></div>
											<div class="ant-input-wrapper ant-input-group css-1s3dcof"></div>
											<div class="ant-input-affix-wrapper ant-input-affix-wrapper-borderless css-1s3dcof"></div>
											<!-- 	<div class="ant-input-prefix col-xl-12" >
														<input placeholder="식품 검색" class="ant-input ant-input-borderless css-1s3dcof col-xl-10" type="text" value="">
														<button type="button"
														class="ant-btn css-1s3dcof ant-btn-default ant-input-search-button col-xl-2"> 검색 </button></div> -->
