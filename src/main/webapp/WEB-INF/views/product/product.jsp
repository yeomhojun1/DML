				...
				<div class="container-fluid">
					...
					<div
						...
						<a href="#"
							...
							class="fas fa-download fa-sm text-white-50"></i>main</a>
					</div>
										...
										<div class="col mr-2">
											...
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
													...
													<a class="h5 mb-0 mr-3 font-weight-bold text-gray-800" href="https://ptsports.co.kr/" >운동기구 바로가기</a>
												</div>
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<a class="h5 mb-0 font-weight-bold text-gray-800" href="https://www.myprotein.co.kr/">
											 단백질보충제 & 건강보조식품</a>
										</div>
										<div class="col-auto">
