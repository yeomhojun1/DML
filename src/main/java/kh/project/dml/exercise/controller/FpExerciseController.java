...
//	}
//	@GetMapping("/one")
//	public ModelAndView selectOneexercise(ModelAndView mv, String mid) {
//		mv.addObject("exerciseone", fpexerciseService.selectOne(mid));
...
//	}
//	@GetMapping("/update")
//	public ModelAndView updateexercise(ModelAndView mv, String mid ) {
//		mv.addObject("exerciseone", fpexerciseService.selectOne(mid));
...
//		String viewPage = "redirect:/";
//		int result = fpexerciseService.delete(mid);
//		try {
//			if (result < 1) {
